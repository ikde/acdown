...
/*
			...
			//CNTV
			if (url.Contains("cntv.cn/") && !url.Contains("tv.cntv.cn/live")) return true;
			//pps.tv
			if (url.StartsWith("http://v.pps.tv/play_")) return true;
			//迅雷看看
